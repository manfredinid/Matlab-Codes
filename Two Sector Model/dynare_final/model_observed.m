...
erase_compiled_function('model_observed_static');
erase_compiled_function('model_observed_dynamic');
M_.orig_eq_nbr = 6;
M_.eq_nbr = 6;
M_.ramsey_eq_nbr = 0;
...
oo_.exo_steady_state( 2 ) = pi_pF_obser;
oo_.exo_steady_state( 1 ) = pi_gF_obser;
...
perfect_foresight_solver;
resid;
save('model_observed_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('model_observed_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('model_observed_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('model_observed_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('model_observed_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('model_observed_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('model_observed_results.mat', 'oo_recursive_', '-append');
end
