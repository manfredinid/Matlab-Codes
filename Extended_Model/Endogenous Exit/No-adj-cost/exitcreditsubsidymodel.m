...
Params.upsilon = kron(pistar_s',[1-Params.g_ear; Params.g_ear]);
...
%% Return Function
ReturnFn=@(aprime_val, a_val,s_val, psi_val, p,w,r_market,r_ear, alpha,gamma, delta,cf) ExistingFirm_ReturnFn(aprime_val, a_val,s_val, psi_val, p,w,r_market,r_ear, alpha,gamma, delta,cf);
...
vfoptions.ReturnToExitFn=@(a_val,s_val, psi_val)0; 
