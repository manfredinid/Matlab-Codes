...
% Entry and Exit
Params.ce=1;%2*Params.cf; % Fixed cost of entry 
%4
%% States
...
%%
vfoptions.ReturnToExitFn=@(kprime_val,s_val, psi_val,p,w,alpha,gamma,cf) 1.4*(((s_val*p*gamma))^(1/(1-gamma)) *kprime_val^(alpha/(1-gamma)))+kprime_val; 
