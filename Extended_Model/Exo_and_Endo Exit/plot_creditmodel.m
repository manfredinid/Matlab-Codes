...
%%
a11 = squeeze(Params.ebar(:,:,1,1));
a21 = squeeze(Params.ebar(:,:,2,1));
a12 = squeeze(Params.ebar(:,:,1,2));
a22 = squeeze(Params.ebar(:,:,2,2));

figure; 
subplot(2,2,1)
stem3(a11(end-30:end,:), 'Color', 'b')
title('Tax and Good Credit')
ylabel('Capital') 
xlabel('Productivity')
zlabel('Entry Decision') 
subplot(2,2,2)
stem3(a21(end-30:end,:), 'Color', 'b')
title('Sub and Good Credit')
ylabel('Capital') 
xlabel('Productivity')
zlabel('Exit Decision') 
subplot(2,2,3)
stem3(a12(end-30:end,:),':diamondr')
title('Tax and Bad Credit')
ylabel('Capital') 
xlabel('Productivity')
zlabel('Entry Decision') 
subplot(2,2,4)
stem3(a22(end-30:end,:), ':diamondr')
