...
SkipInitialFinal= 1 % 0 to SKIP transition path


% tic;

%% Endogenous and Exogenous States
n_s= 15; % number of firm-specific Productivity level
...
%% Transition Path
   ...
   Params.p=p_eqm.p;
   Params.Ne=p_eqm.Ne;
   [V_initial,Policy_initial]=ValueFnIter_Case1(n_d,n_a,n_z,[],a_grid,z_grid, pi_z,...
   ...
   Params.p=p_eqm.p;
   Params.Ne=p_eqm.Ne;
   [V_final,Policy_final]=ValueFnIter_Case1(n_d,n_a,n_z,[],a_grid,z_grid, pi_z,...
       ReturnFn, Params, DiscountFactorParamNames, ReturnFnParamNames,vfoptions);
   ...
   ParamPath.tau=Params.taurate_final*ones(T,1);
%    ParamPathNames={'tau'};
