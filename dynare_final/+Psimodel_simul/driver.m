...
diary off;
diary('Psimodel_simul.log');
M_.exo_names = cell(2,1);
M_.exo_names_tex = cell(2,1);
M_.exo_names_long = cell(2,1);
M_.exo_names(1) = {'pi_g'};
M_.exo_names_tex(1) = {'pi\_g'};
M_.exo_names_long(1) = {'pi_g'};
M_.exo_names(2) = {'pi_p'};
M_.exo_names_tex(2) = {'pi\_p'};
M_.exo_names_long(2) = {'pi_p'};
...
M_.mapping.pi_g.eqidx = [1 ];
M_.mapping.pi_p.eqidx = [1 ];
...
perfect_foresight_solver;
resid;
save('Psimodel_simul_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Psimodel_simul_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Psimodel_simul_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Psimodel_simul_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Psimodel_simul_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('Psimodel_simul_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('Psimodel_simul_results.mat', 'oo_recursive_', '-append');
end
